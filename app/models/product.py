...
class Product(Base):
    ...
    barcode = Column(String(50), unique=True, index=True, nullable=True)  # barcode principal opcional
...
class PriceListItem(Base):
    ...
    __table_args__ = (
        Index("ix_plitem_plid_prod", "price_list_id", "product_id", unique=True),
    )
