...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_pos_order_idempotency_key"), "pos_order", ["idempotency_key"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_pos_payment_idempotency_key"), "pos_payment", ["idempotency_key"], unique=True
    )
    op.create_table(
        "pos_payment_split",
        sa.Column("id", sa.Integer(), nullable=False),
